@extends('layouts.app')
@section('title', 'Alumnus szerkesztése')
...
<div class="container">
    ...
    <form action="{{ route('alumni.update', $alumnus) }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="form-group row mb-3">
            ...
            <div class="col-sm-10">
                <input type="text" class="form-control @error('name') is-invalid @enderror" id="name" name="name" value="{{ old('name', $alumnus->name) }}">
                @error('name')
        ...
        <div class="form-group row mb-3">
            ...
            <div class="col-sm-10">
                <input type="text" class="form-control @error('email') is-invalid @enderror" id="email" name="email" value="{{ old('email', $alumnus->email) }}">
                @error('email')
                    <div class="invalid-feedback">
                        {{ $message }}
                    </div>
        ...
        <div class="form-group row mb-3">
            ...
            <div class="col-sm-10">
                <input type="number" class="form-control @error('birth_date') is-invalid @enderror" id="birth_date" name="birth_date" value="{{ old('birth_date', $alumnus->birth_date) }}">
                @error('birth_date')
                    <div class="invalid-feedback">
                        {{ $message }}
                    </div>
        ...
        <div class="form-group row mb-3">
            ...
            <div class="col-sm-10">
                <input type="text" class="form-control @error('birth_place') is-invalid @enderror" id="birth_place" name="birth_place" value="{{ old('birth_place', $alumnus->birth_place) }}">
                @error('birth_place')
                    <div class="invalid-feedback">
                        {{ $message }}
                    </div>
        ...
        <div class="form-group row mb-3">
            ...
            <div class="col-sm-10">
                <input type="text" class="form-control @error('high_school') is-invalid @enderror" id="high_school" name="high_school" value="{{ old('high_school', $alumnus->high_school) }}">
                @error('high_school')
                    <div class="invalid-feedback">
                        {{ $message }}
                    </div>
        ...
        <div class="form-group row mb-3">
            ...
            <div class="col-sm-10">
                <input type="number" class="form-control @error('graduation_date') is-invalid @enderror" id="graduation_date" name="graduation_date" value="{{ old('graduation_date', $alumnus->graduation_date) }}">
        ...
        <div class="form-group row mb-3">
            ...
            <div class="col-sm-10">
                <input type="number" class="form-control @error('start_of_membership') is-invalid @enderror" id="start_of_membership" name="start_of_membership" value="{{ old('start_of_membership', $alumnus->start_of_membership) }}">
        ...
        <div class="form-group row mb-3">
            ...
            <div class="col-sm-10">
                <textarea rows="5" class="form-control @error('further_course_detailed') is-invalid @enderror" id="further_course_detailed" name="further_course_detailed">{{ old('further_course_detailed', $alumnus->further_course_detailed) }}</textarea>
        ...
        <div class="form-group row mb-3">
            ...
            <div class="col-sm-10">
                <textarea rows="5" class="form-control @error('recognations') is-invalid @enderror" id="recognations" name="recognations">{{ old('recognations', $alumnus->recognations) }}</textarea>
                @error('recognations')
                    <div class="invalid-feedback">
                        {{ $message }}
                    </div>
        ...
        <div class="form-group row mb-3">
            ...
            <div class="col-sm-10">
                <textarea rows="5" class="form-control @error('works') is-invalid @enderror" id="works" name="works">{{ old('works', $alumnus->works) }}</textarea>
                @error('works')
                    <div class="invalid-feedback">
                        {{ $message }}
                    </div>
        ...
        <div class="form-group row mb-3">
            ...
            <div class="col-sm-10">
                <textarea rows="5" class="form-control @error('research_field_detailed') is-invalid @enderror" id="research_field_detailed" name="research_field_detailed">{{ old('research_field_detailed', $alumnus->research_field_detailed) }}</textarea>
        ...
        <div class="form-group row mb-3">
            ...
            <div class="col-sm-10">
                <input type="text" class="form-control @error('links') is-invalid @enderror" id="links" name="links" value="{{ old('links', $alumnus->links) }}">
                @error('links')
                    <div class="invalid-feedback">
                        {{ $message }}
                    </div>
